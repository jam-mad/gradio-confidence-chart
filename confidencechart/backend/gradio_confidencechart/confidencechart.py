...
class ConfidenceChart(Component):
    """
    Displays classification confidence scores as animated horizontal bar charts.
    Accepts the same data format as gr.Label and can be used as a drop-in replacement.
    """
    ...
    def postprocess(
        ...
        raise ValueError(
            "The `ConfidenceChart` output interface expects one of: a string label, or an int label, a "
